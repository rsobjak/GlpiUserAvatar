...
//                               return {results: data.results};
   ...
   **/
   ...
   private static function displayTopMenu($full) {
      ...
      //Plugin GLPI User Avatar
      include('inc/includes.php');
      $plAvatar = new Plugin();
      if ($plAvatar->isActivated("useravatar")) {
        echo "<li id='avatar'>";
        echo "<span style='font-size:18px;'><a href='".$CFG_GLPI["root_doc"]."/front/preference.php'><img src=\"" . $_SESSION["foto"] . "\" alt='' title='' class='avatar' style='height: 40px; margin-left: 0px; ' /></a></span>";
        echo "</li>";
        echo'<style> img.avatar {border: 2px solid #fff;border-radius: 50%; margin-left: 10px; width: 43px; height: 60px;}</style>';
      }
